...
pub struct KeyBindings {
    ...
    pub hotbar2_slot_1: KeyBinding,
    pub hotbar2_slot_2: KeyBinding,
    pub hotbar2_slot_3: KeyBinding,
    pub hotbar2_slot_4: KeyBinding,
    pub hotbar2_slot_5: KeyBinding,
    pub hotbar2_slot_6: KeyBinding,
    pub hotbar2_slot_7: KeyBinding,
    pub hotbar2_slot_8: KeyBinding,
    pub hotbar2_slot_9: KeyBinding,
    pub hotbar2_slot_10: KeyBinding,
    pub hotbar2_slot_11: KeyBinding,
    pub hotbar2_slot_12: KeyBinding,
...
impl Default for KeyBindings {
    fn default() -> Self {
        Self {
            ...
            hotbar2_slot_1: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit1" } else { "Alt+Digit1" }.to_string(), "".to_string()]),
            hotbar2_slot_2: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit2" } else { "Alt+Digit2" }.to_string(), "".to_string()]),
            hotbar2_slot_3: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit3" } else { "Alt+Digit3" }.to_string(), "".to_string()]),
            hotbar2_slot_4: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit4" } else { "Alt+Digit4" }.to_string(), "".to_string()]),
            hotbar2_slot_5: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit5" } else { "Alt+Digit5" }.to_string(), "".to_string()]),
            hotbar2_slot_6: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit6" } else { "Alt+Digit6" }.to_string(), "".to_string()]),
            hotbar2_slot_7: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit7" } else { "Alt+Digit7" }.to_string(), "".to_string()]),
            hotbar2_slot_8: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit8" } else { "Alt+Digit8" }.to_string(), "".to_string()]),
            hotbar2_slot_9: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit9" } else { "Alt+Digit9" }.to_string(), "".to_string()]),
            hotbar2_slot_10: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Digit0" } else { "Alt+Digit0" }.to_string(), "".to_string()]),
            hotbar2_slot_11: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Minus" } else { "Alt+Minus" }.to_string(), "".to_string()]),
            hotbar2_slot_12: KeyBinding([if cfg!(target_os = "macos") { "Ctrl+Equal" } else { "Alt+Equal" }.to_string(), "".to_string()]),
