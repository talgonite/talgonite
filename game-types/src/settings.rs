...
impl Default for KeyBindings {
    fn default() -> Self {
        Self {
            ...
            hotbar2_slot_1: KeyBinding(["Alt+Digit1".to_string(), "".to_string()]),
            hotbar2_slot_2: KeyBinding(["Alt+Digit2".to_string(), "".to_string()]),
            hotbar2_slot_3: KeyBinding(["Alt+Digit3".to_string(), "".to_string()]),
            hotbar2_slot_4: KeyBinding(["Alt+Digit4".to_string(), "".to_string()]),
            hotbar2_slot_5: KeyBinding(["Alt+Digit5".to_string(), "".to_string()]),
            hotbar2_slot_6: KeyBinding(["Alt+Digit6".to_string(), "".to_string()]),
            hotbar2_slot_7: KeyBinding(["Alt+Digit7".to_string(), "".to_string()]),
            hotbar2_slot_8: KeyBinding(["Alt+Digit8".to_string(), "".to_string()]),
            hotbar2_slot_9: KeyBinding(["Alt+Digit9".to_string(), "".to_string()]),
            hotbar2_slot_10: KeyBinding(["Alt+Digit0".to_string(), "".to_string()]),
            hotbar2_slot_11: KeyBinding(["Alt+Minus".to_string(), "".to_string()]),
            hotbar2_slot_12: KeyBinding(["Alt+Equal".to_string(), "".to_string()]),
