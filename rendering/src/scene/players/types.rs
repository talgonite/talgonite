    ...
    pub fn z_priority(&self, towards: bool) -> f32 {
        match towards {
            true => match self {
                ...
                PlayerPieceType::HelmetBg => 0.22,
                PlayerPieceType::Boots => 0.21,
                PlayerPieceType::Pants => 0.2,
                PlayerPieceType::Arms => 0.12,
                PlayerPieceType::Face => 0.11,
                PlayerPieceType::Body => 0.1,
                PlayerPieceType::Accessory1Bg => 0.093,
                PlayerPieceType::Accessory2Bg => 0.092,
                PlayerPieceType::Accessory3Bg => 0.091,
            },
            false => match self {
                PlayerPieceType::Accessory1Fg => 0.93,
                PlayerPieceType::Accessory2Fg => 0.92,
