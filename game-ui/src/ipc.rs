...
pub struct KeyBindingsUi {
    ...
    pub hotbar2_slot_1: [String; 2],
    pub hotbar2_slot_2: [String; 2],
    pub hotbar2_slot_3: [String; 2],
    pub hotbar2_slot_4: [String; 2],
    pub hotbar2_slot_5: [String; 2],
    pub hotbar2_slot_6: [String; 2],
    pub hotbar2_slot_7: [String; 2],
    pub hotbar2_slot_8: [String; 2],
    pub hotbar2_slot_9: [String; 2],
    pub hotbar2_slot_10: [String; 2],
    pub hotbar2_slot_11: [String; 2],
    pub hotbar2_slot_12: [String; 2],
...
impl From<&KeyBindings> for KeyBindingsUi {
    fn from(kb: &KeyBindings) -> Self {
        Self {
            ...
            hotbar2_slot_1: kb.hotbar2_slot_1.0.clone(),
            hotbar2_slot_2: kb.hotbar2_slot_2.0.clone(),
            hotbar2_slot_3: kb.hotbar2_slot_3.0.clone(),
            hotbar2_slot_4: kb.hotbar2_slot_4.0.clone(),
            hotbar2_slot_5: kb.hotbar2_slot_5.0.clone(),
            hotbar2_slot_6: kb.hotbar2_slot_6.0.clone(),
            hotbar2_slot_7: kb.hotbar2_slot_7.0.clone(),
            hotbar2_slot_8: kb.hotbar2_slot_8.0.clone(),
            hotbar2_slot_9: kb.hotbar2_slot_9.0.clone(),
            hotbar2_slot_10: kb.hotbar2_slot_10.0.clone(),
            hotbar2_slot_11: kb.hotbar2_slot_11.0.clone(),
            hotbar2_slot_12: kb.hotbar2_slot_12.0.clone(),
